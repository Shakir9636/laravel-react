...
use App\Http\Resources\UserCrudRecource;
...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return inertia("User/Index", [
            "users" => UserCrudRecource::collection($users),
    ...
    public function edit(User $user)
    {
        return inertia("User/Edit", [
            'user' => new UserCrudRecource($user),
        ]);
    }
    ...
    public function destroy(User $user)
    {
        ...
        $name = $user->name;
        if($id == $user->id){
            return to_route('user.index')->with('success',"Log in User not delete");
        }
        $user->delete();
